...
@implementation Seed
{
    ...
    C4Shape *seed, *cone;
    NSMutableArray *filtered, *filteredSalmonArray0, *filteredSalmonArray1, *filteredSalmonArray2, *filteredSalmonArray3, *filteredSalmonArray4, *filteredSalmonArray5, *filteredSalmonArray6, *filteredSalmonArray7, *filteredSalmonArray8, *filteredSalmonArray9, *filteredSalmonArray10, *filteredSalmonArray11, *filteredSalmonArray12, *filteredTealArray1, *filteredTealArray2, *filteredTealArray3, *filteredTealArray4, *filteredTealArray5, *filteredTealArray6, *filteredTealArray7, *filteredTealArray8;
}
