...
-(void)setup
{
    ...
    square = [C4Shape rect:CGRectMake(2*x,((self.height)-4*x),x,-x)];
    square.strokeColor = color2;
    square.fillColor = [UIColor whiteColor];

    square1 = [C4Shape rect:CGRectMake(2*x,((self.height)-5*x),x,-x)];
    square1.strokeColor = color2;
    square1.fillColor = [UIColor whiteColor];

    square2 = [C4Shape rect:CGRectMake(0,((self.height)-5*x),2*x,-2*x)];
    square2.strokeColor = color2;
    square2.fillColor = [UIColor whiteColor];

    square3 = [C4Shape rect:CGRectMake(0,((self.height)-3*x),3*x,-3*x)];
    square3.strokeColor = color2;
    square3.fillColor = [UIColor whiteColor];

    square5 = [C4Shape rect:CGRectMake(3*x,((self.height)-5*x),5*x,-5*x)];
    square5.strokeColor = color2;
    square5.fillColor = [UIColor whiteColor];

    square8 = [C4Shape rect:CGRectMake(0,((self.height)-13*x),8*x,-8*x)];
    ...
    allSquares.fillColor = [UIColor whiteColor];
    allSquares.strokeColor = [UIColor whiteColor];
    
    //allCountLabels.textAlignment = ALIGNTEXTCENTER;
    
    int c = 43;
    
    allCountLabels = [C4Shape rect:CGRectMake(0, 0, 13*x, 100)];
    allCountLabels.fillColor = [UIColor whiteColor];
    allCountLabels.strokeColor = [UIColor clearColor];
    allCountLabels.center = CGPointMake(9*x,(self.height/2)-8);
    ...
    countLabel0.textColor = color5;
    countLabel.textColor = color5;
    countLabel1.textColor = color5;
    countLabel2.textColor = color5;
    countLabel3.textColor = color5;
    countLabel5.textColor = color5;
    countLabel8.textColor = color5;
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self runMethod:@"addSquare" afterDelay:2.0f];
}
...
-(void)addSquare
{
    ...
    [self runMethod:@"addSquareOne" afterDelay:2.0f];
}
...
-(void)addSquareOne
{
    ...
    [self runMethod:@"addSquareTwo" afterDelay:2.0f];
}
...
-(void)addSquareTwo
{
    ...
    [self runMethod:@"addSquareThree" afterDelay:2.0f];
}
...
-(void)addSquareThree
{
    ...
    [self runMethod:@"addSquareFive" afterDelay:2.0f];
}
...
-(void)addSquareFive
{
    ...
    [self runMethod:@"addSquareEight" afterDelay:2.0f];
}
